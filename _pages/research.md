...
## Magnetic materials
In magnetism, I am particularly interested in simulating how thermally induced spin fluctuations can alter the electronic structure and physical properties of materials. Much of my previous work has focussed on hard magnetic materials, _i.e._ permanent magnets, where I have worked extensively on modelling of the atomically ordered L1<sub>0</sub> phase of FeNi, also known as the meteoritic mineral [tetrataenite](https://en.wikipedia.org/wiki/Tetrataenite). In this system, using fully relativistic DFT and appropriate techniques for averaging over compositional and magnetic disorder, I’ve looked in detail at how the material's magnetocrystalline anisotropy energy (determining how strong a magnet is) depends on composition, chemical order, and temperature. More recently, I have also spent some time investigating how magnetic moment disorder affects the electronic structure of so-called 'altermagnetic' materials such as CrSb and MnTe.
...
* <b>C. D. Woodgate</b>, N. Menai, A. Ernst, J. B. Staunton, <i>"Loss of altermagnetic order and smooth restoration of Kramers' spin degeneracy with increasing temperature in CrSb and MnTe"</i>, [arXiv:2603.15035](https://doi.org/10.48550/arXiv.2603.15035)
...
<figure class="align-center">
  ...
  <figcaption>Sketch of some of the parallelisation strategies for the Wang-Landau sampling algorithm which we benchmarked in recent work. Reproduced from Comput. Phys. Commun. <b>324</b>, 110125 (2026).</figcaption>
</figure> 

### Selected publications
* H. J. Naguszewski, L. B. Partay, D. Quigley, <b>C. D. Woodgate</b>, <i>"BraWl: Simulating the thermodynamics and phase stability of multicomponent alloys using conventional and enhanced sampling techniques,"</i> [Journal of Open Source Software <b>10</b>, 8346 (2025)](https://doi.org/10.21105/joss.08346).
