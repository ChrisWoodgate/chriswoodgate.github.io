...
I have authored a book outlining the approach we have developed for modelling atomic arrangements in multicomponent alloys, which is based on a perturbative analysis of the internal energy of the disordered alloy as described within the Korringa–Kohn–Rostoker (KKR) formulation of density functional theory (DFT), using the coherent potential approximation (CPA) to average over chemical disorder. It represents an enlarged and extensively reworked version of my doctoral thesis, including new results and additional commentary.
